...
from .session_runtime import (
    ...
    create_runtime_session_id,
    get_runtime_session_storage_dir,
...
def ide(
    ...
    service: str | None = typer.Option(
        None,
        "--service",
        help="模型服务商，可选 ccswitch、ai952048、opencode、openai、deepseek、claude、mimo、baisub。",
    ),
