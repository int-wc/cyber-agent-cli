...
BUILTIN_COMMAND_SPECS: tuple[BuiltinCommandSpec, ...] = (
    ...
    BuiltinCommandSpec("/memory search <关键词>", "检索持久化记忆"),
    BuiltinCommandSpec("/memory delete <名称>", "删除持久化记忆"),
    BuiltinCommandSpec("/doctor", "查看当前运行诊断"),
    BuiltinCommandSpec("/status", "查看当前会话与配置状态", show_in_banner=True),
    BuiltinCommandSpec("/version", "查看当前 CLI 版本"),
    ...
    BuiltinCommandSpec("/new", "新建并切换到空白会话"),
    BuiltinCommandSpec("/trace", "查看管线执行轨迹 (/trace list)", show_in_banner=True),
